          ...
          <div className={`grid gap-4 sm:gap-5 ${user?.role === "STAFF" ? "grid-cols-1 md:grid-cols-3" : "grid-cols-1 md:grid-cols-3 lg:grid-cols-3"}`}>
            ...
            >
              <div>
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-neutral-900 tracking-tight">{t("home.displayQrCode")}</h3>
                <p className="mt-2 text-sm text-neutral-600">{t("home.displayQrCodeDesc")}</p>
              </div>
