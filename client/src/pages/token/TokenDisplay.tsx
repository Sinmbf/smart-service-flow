...
const TokenDisplay = () => {
  ...
  const tokenData = location.state as TokenState;

  const [currentServing, setCurrentServing] = useState<string>("A001");
            ...
            <div className="space-y-6 py-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-2">
                ...
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <span className="text-gray-600 font-medium text-xs sm:text-sm block mb-2">
                ...
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  ...
                  <span className="text-gray-900 font-semibold text-2xl sm:text-3xl">
